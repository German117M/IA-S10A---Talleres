...
# Después debes reemplazarlas o ampliarlas con reglas propias.
CUSTOM_RULES = {
...
def contains_keyword(text: str, keyword: str) -> bool:
    # Compara palabras o frases completas para evitar falsos positivos
...
def read_cases() -> list[str]:
    ...
    # utf-8-sig elimina un BOM UTF-8 si el CSV
    # fue guardado por Excel u otro editor.
    with CSV_FILE.open(
        "r",
        encoding="utf-8-sig",
        newline=""
